...
CREATE TABLE IF NOT EXISTS `tbl_goods_info` (
  ...
  KEY `idx` (`idx`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='상품정보테이블';
...
CREATE TABLE IF NOT EXISTS `tbl_member` (
  ...
  `ststus` char(1) DEFAULT NULL COMMENT '회원선택(사용중,N탈퇴,P중지)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='주문 상세 정보 테이블';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='주문정보 테이블';
